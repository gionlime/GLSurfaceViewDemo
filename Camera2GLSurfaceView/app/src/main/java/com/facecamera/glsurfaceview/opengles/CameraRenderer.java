package com.facecamera.glsurfaceview.opengles;
...
public class CameraRenderer implements GLSurfaceView.Renderer {
    ...
    public void init(GLSurfaceView surfaceView, Camera2Manager camera, boolean isPreviewStarted, Context context) {
        mContext = context;
